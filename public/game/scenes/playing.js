...
import { playerToken, submitScore, surrender, updateScore, } from "../playt";
...
export default class PlayingScene extends Phaser.Scene {
    constructor() {
        ...
        this.liveMatch = null;
        this.sendLiveMatchUpdate = throttle((command) => {
            if (this.liveMatch) {
    ...
    preload() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.liveMatch = yield client.subscribeLiveMatch(playerToken, (data) => {
    ...
    create() {
        ...
        const difficulty = JSON.parse(this.data.get("difficulty"));
        const bombVelocity = {
            easy: 20,
            normal: 300,
            hard: 800,
        ...
        const othersScore = this.replays
            .map((replay, index) => `${replay.name}: ${this.otherScores[index]}/${replay.score}`)
            .join(" ");
